package youdu.com.imoocsdk.constant;
...
public class SDKConstant {
    ...
    public static AutoPlaySetting mCurrentSetting;

    public static void setCurrentSetting(AutoPlaySetting currenSetting) {
        mCurrentSetting = currenSetting;
    }
