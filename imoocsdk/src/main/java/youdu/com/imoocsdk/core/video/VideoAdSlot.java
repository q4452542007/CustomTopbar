...
import youdu.com.imoocsdk.widget.VideoFullDialog;
import youdu.com.imoocsdk.widget.VideoFullDialog.FullToSmallListener;
...
public class VideoAdSlot implements CustomVideoView.ADVideoPlayerListener {
    ...
    private ViewGroup mParentView;  //CustomVideoView要添加到的父容器
    /**
     * Data
     */
