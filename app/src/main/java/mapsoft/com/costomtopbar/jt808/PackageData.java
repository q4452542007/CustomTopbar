...
public class PackageData {
	...
	public PackageData(MsgHeader msgHeader, int checkSum) {
		this.msgHeader = msgHeader;
		this.checkSum = checkSum;
	}
	...
	public static class MsgHeader {
		...
		// 保留位[14-15]
		protected String reservedBit = "0";
		/////// ========消息体属性
		...
		//////// =====消息包封装项
		// byte[12-15]
		protected int packageInfoField = 0;
		// 消息包总数(word(16))
		protected long totalSubPackage = 0;
		// 包序号(word(16))这次发送的这个消息包是分包中的第几个消息包, 从 1 开始
		protected long subPackageSeq = 0;
		//////// =====消息包封装项
		...
		public MsgHeader(int msgId, int msgBodyLength, String terminalPhone, int flowId) {
			this.msgId = msgId;
